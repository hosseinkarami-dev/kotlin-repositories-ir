...
## 📌 ترتیب قرارگیری مخازن

گریدل وابستگی‌ها را به ترتیب مخازن تعریف‌شده بررسی می‌کند. به همین دلیل، بهتر است **میرورهای مخازن** را قبل از **مخزن گوگل**، **مرکز مخازن میون** و **پرتال افزونه‌های گریدل** قرار دهید.

در این حالت، گریدل ابتدا وابستگی‌ها را از میرورهای مخازن دریافت می‌کند و تنها در صورت نیاز به مخازن رسمی مراجعه خواهد کرد. این کار معمولاً باعث افزایش سرعت دریافت وابستگی‌ها و پایداری بیشتر فرایند همگام‌سازی و ساخت پروژه می‌شود.
